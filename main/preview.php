						...
						<div style="width: 100%; height: 190px;">
							<div style="width: 900px; float: left;">
								<center>
									...
									<img src="img/yuanrose.png" width="100" alt=""><br>
									Yuan Rose Trading, Construction,<br> and Hardware Supply Corporation<br> <br>
								</center>
								<div>
									<?php
								...
								<tbody>
									...
									?>
										<tr class="record">
											...
											$catquer = mysqli_query($mysqli, $query);

											while ($rows = mysqli_fetch_assoc($catquer)) {
											?>
