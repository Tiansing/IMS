		...
		<div class="row-fluid">
			<div class="span2">
				<div class="well sidebar-nav">
					<ul class="nav nav-list">
						...
						<li class="active"><a href="sales_inventory.php"><i class="icon-exchange icon-2x"></i> Return Item </a> </li>
			...
			<div class="span10">
				<div class="contentheader">
					<i class="icon-exchange "></i> Return Item
				</div>
				<br>
				...
				<div class="content" id="content">
					<br><br><br>
					<center><strong>Inventory of Sold Items</strong></center>
							...
							?>
								<tr class="record">
									...
									<td><?php
										...
										?></td>
									<td>
										<a rel="facebox" href="editsales_inventory.php?id=<?php echo $row['transaction_id']; ?>"><button class="btn btn-mini btn-danger"><i class="icon icon-share-alt"></i> Return </button></a>
								</tr>
							<?php
							}
							?>
